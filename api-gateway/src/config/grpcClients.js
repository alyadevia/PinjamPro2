...
const itemClient = new itemProto.item.ItemService(
  process.env.ITEM_SERVICE_URL || 'https://backend-production-cf75a.up.railway.app:50052',
  grpc.credentials.createInsecure()
);

const borrowingClient = new borrowingProto.borrowing.BorrowingService(
  process.env.BORROWING_SERVICE_URL || 'https://backend-production-cf75a.up.railway.app:50053',
  grpc.credentials.createInsecure()
);

const notificationClient = new notificationProto.notification.NotificationService(
  process.env.NOTIFICATION_SERVICE_URL || 'https://backend-production-cf75a.up.railway.app:50054',
  grpc.credentials.createInsecure()
);
